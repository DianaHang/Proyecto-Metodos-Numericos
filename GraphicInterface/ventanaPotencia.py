...
def ventanaPotencia():
    ...
    # Resolver método de la potencia
    def resolver_potencia():
        try:
            ...
            # Verificar vector no nulo
            if np.allclose(x0, 0):
                messagebox.showerror("Error", "El vector inicial x0 no puede ser el vector nulo.")
                return
    ...
    btn_resolver = tk.Button(sub, text="Calcular", font=("Arial", 12), command=resolver_potencia)
